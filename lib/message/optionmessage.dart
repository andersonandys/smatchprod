    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ListTile(
            onTap: () {
              print(widget.typemessage);
              smscontroller.typereponse.value = widget.typemessage;
              smscontroller.messagereponse.value = widget.message;
              smscontroller.idmessagereponse.value = widget.idmessage;
              smscontroller.nomreponse.value = widget.namereponse;
              print(widget.namereponse);
          ...
          ListTile(
            onTap: () {
              FlutterClipboard.copy(widget.message)
                  .then((value) => print(widget.message));
              Navigator.of(context).pop();
            },
            leading: Icon(
              Icons.copy,
